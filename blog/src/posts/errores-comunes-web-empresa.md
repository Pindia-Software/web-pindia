...
Solución: PageSpeed Insights y plan de mejora. Imágenes WebP, caché, plugins limpios.
...
Solución: implementar un Consent Management Platform serio (Cookiebot, Iubenda o similar) y cargar los scripts después del consentimiento, no antes.
