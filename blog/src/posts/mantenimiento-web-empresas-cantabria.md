...
**Copias de seguridad**: diarias y automatizadas, guardadas fuera del servidor de producción, con prueba periódica de que la copia se puede restaurar de verdad. Una copia que nadie ha probado restaurar no es una copia, es un archivo.

**Monitorización**: alertas cuando la web cae, cuando carga lento, cuando aparece un error 500, cuando algún certificado va a caducar. Lo ideal es enterarte tú antes que tu cliente.

**Soporte**: una persona que conoce tu web y a la que puedes llamar cuando algo va mal. Suena obvio. Es lo que más falla en el mercado.
...
- [Los 10 errores más comunes en webs de empresa](https://pindia.es/blog/posts/errores-comunes-web-empresa/), muchos errores vienen de falta de mantenimiento.
